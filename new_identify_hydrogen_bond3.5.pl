...
# if(@{$chainID[$i]}/2==1)
 ...
 for($z=0;$z<@rec;$z++)
   {$res=substr($rec[$z],17,9);
    ...
    $angle1=0;
    $angle2=0;
    if(($dist_N<3.5)&&(substr($rec[$z],13,3) eq "OH ")) #TYR
      {
       $vector2x=$x_r-$x_n[$k];
       $vector2y=$y_r-$y_n[$k];
       $vector2z=$z_r-$z_n[$k];
    ...
    elsif(($dist_N<3.5)&&(substr($rec[$z],13,3) eq "OG "))#SER
      {
       $vector2x=$x_r-$x_n[$k];
       $vector2y=$y_r-$y_n[$k];
       $vector2z=$z_r-$z_n[$k];
    ...
    elsif(($dist_N<3.5)&&(substr($rec[$z],13,3) eq "OG1")) #THR
      {
       $vector2x=$x_r-$x_n[$k];
       $vector2y=$y_r-$y_n[$k];
       $vector2z=$z_r-$z_n[$k];
    ...
    elsif(($dist_N<3.5)&&(substr($rec[$z],13,3) eq "N  ")) ##backbone NH
    ...
    elsif(($dist_N<3.5)&&((substr($rec[$z],13,3) eq "NH1")||(substr($rec[$z],13,3) eq "NH2")||(substr($$rec[$z],13,3) eq "NE "))) #ARG
      {
       $vector2x=$x_r-$x_n[$k];
       $vector2y=$y_r-$y_n[$k];
       $vector2z=$z_r-$z_n[$k];
    ...
    elsif(($dist_N<3.5)&&(substr($rec[$z],13,3) eq "NZ "))#LYS
      {
       $vector2x=$x_r-$x_n[$k];
       $vector2y=$y_r-$y_n[$k];
       $vector2z=$z_r-$z_n[$k];
    ...
    elsif(($dist_N<3.5)&&(substr($rec[$z],13,3) eq "ND2")) # ASN
      {
       $vector2x=$x_r-$x_n[$k];
       $vector2y=$y_r-$y_n[$k];
       $vector2z=$z_r-$z_n[$k];
    ...
    elsif(($dist_N<3.5)&&(substr($rec[$z],13,3) eq "NE2")&&(substr($rec[$z],17,3) eq "GLN")) # GLN
      {
       $vector2x=$x_r-$x_n[$k];
       $vector2y=$y_r-$y_n[$k];
       $vector2z=$z_r-$z_n[$k];
    ...
    elsif(($dist_N<3.5)&&((substr($rec[$z],13,3) eq "NE2")||(substr($rec[$z],13,3) eq "ND1"))&&((substr($rec[$z],17,3) eq "HIS")||(substr($rec[$z],17,3) eq "HIE")||(substr($rec[$z],17,3) eq "HID")))#HIS
      {
       $vector2x=$x_r-$x_n[$k];
       $vector2y=$y_r-$y_n[$k];
       $vector2z=$z_r-$z_n[$k];
    ...
    elsif(($dist_N<3.5)&&(substr($rec[$z],13,3) eq "NE1")) #TRP
      {
       $vector2x=$x_r-$x_n[$k];
       $vector2y=$y_r-$y_n[$k];
       $vector2z=$z_r-$z_n[$k];
    ...
    elsif(($dist_N<3.5)&&((substr($rec[$z],17,3) eq "HOH")||(substr($rec[$z],17,3) eq "SOL")))
      {
       $vector2x=$x_r-$x_n[$k];
       $vector2y=$y_r-$y_n[$k];
       $vector2z=$z_r-$z_n[$k];
